            ...
            {[
              ...
              },
              {
                ...
                items: [
                  ...
                  "Tools: Web search, weather, stocks, news, dictionary, QR codes, webpage summarizer",
          ...
          <div className="rounded-xl border border-border/40 bg-card/30 p-6 mt-6">
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                { icon: TrendingUpIcon,    title: "Stocks & Crypto",      desc: "Real-time stock and cryptocurrency prices." },
                { icon: GlobeIcon,         title: "Webpage Summarizer",   desc: "Summarize webpage content instantly." },
                { icon: SparklesIcon,      title: "Latest News",          desc: "Get the latest headlines and stories." },
                { icon: QrCodeIcon,        title: "QR Code Generator",    desc: "Create QR codes from text or URLs." },
                ...
                { icon: MessageSquareIcon, title: "Dictionary",           desc: "Look up definitions and meanings." },
